export const stageContent = {
  version: { image: "/media/stages/sunil-head-heart-v3.webp", mobileImage: "", alt: "A translucent head with a heart representing Head–Heart Alignment", focalPoint: "50% 50%", overlay: 0, headline: "Pause.\nReflect.\nChoose wisely.", supporting: "Align what you feel with what you reason.", active: true, order: 1 },
