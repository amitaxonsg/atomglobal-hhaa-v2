export const stageContent = {
  version: { image: "/media/stages/reflection-portrait.png", mobileImage: "", alt: "A thoughtful professional pausing beside a window", focalPoint: "52% 50%", overlay: 42, headline: "Pause.\nReflect.\nChoose wisely.", supporting: "Align what you feel with what you reason.", active: true, order: 1 },
  participant: { image: "/media/stages/participant.webp", mobileImage: "", alt: "A reflective moment before beginning", focalPoint: "46% 50%", overlay: 60, headline: "Begin with\nwhere you are.", supporting: "Your context makes the reflection more useful.", active: true, order: 2 },
  personal: { image: "/media/stages/personal.webp", mobileImage: "", alt: "A quiet moment of personal reflection", focalPoint: "48% 50%", overlay: 60, headline: "Notice the\npattern.", supporting: "There are no right answers—only honest ones.", active: true, order: 3 },
  newjoiner: { image: "/media/stages/new-joiner.webp", mobileImage: "", alt: "A professional considering a new beginning", focalPoint: "48% 50%", overlay: 60, headline: "Find your\nfooting.", supporting: "See how you balance belonging, judgement and instinct.", active: true, order: 4 },
  manager: { image: "/media/stages/manager.webp", mobileImage: "", alt: "A manager reflecting on how they lead", focalPoint: "48% 50%", overlay: 62, headline: "Lead with\nclarity.", supporting: "Understand what your team experiences from you.", active: true, order: 5 },
  executive: { image: "/media/stages/executive.webp", mobileImage: "", alt: "An executive considering a complex decision", focalPoint: "48% 50%", overlay: 64, headline: "Hold the\nwhole picture.", supporting: "Balance evidence, instinct and human consequence.", active: true, order: 6 },
  report: { image: "/media/stages/report-view.webp", mobileImage: "/media/stages/reflection-mobile.webp", alt: "A participant reviewing a personal report", focalPoint: "48% 50%", overlay: 62, headline: "Turn insight\ninto action.", supporting: "Your result is a starting point, not a label.", active: true, order: 7 },
};
